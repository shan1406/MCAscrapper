...
for i in range(0,len(cid)):
    ...
    try:
        ...
        company_name = driver.find_element_by_xpath(".//*[@id='resultTab3']/tbody/tr[2]/td[2]").text
                # for i in email_id:
                #    print(i.text)
                # print(email_id)
        #company_array.append(company_name)

        ROC_code = driver.find_element_by_xpath(".//*[@id='resultTab3']/tbody/tr[5]/td[2]").text
                # for i in email_id:
                #    print(i.text)
                # print(email_id)
        #roc_array.append(ROC_code)

        doi = driver.find_element_by_xpath(".//*[@id='resultTab3']/tbody/tr[6]/td[2]").text
                    # for i in email_id:
                    #    print(i.text)
                    # print(email_id)
        ...
        email_id = driver.find_element_by_xpath(".//*[@id='resultTab3']/tbody/tr[8]/td[2]").text
                    # for i in email_id:
                    #    print(i.text)
                    # print(email_id)
    ...
    ws.append([client_name,company_name,email_id,business,doi,ROC_code])
    wb.save('LLPdata.xls') 
